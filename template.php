...
//function incubator_blogline_alpha_preprocess_block(&$vars) {
//  if (in_array($vars['block']->region, array('header', 'menu', 'header_second', 'branding', 'footer'))) {
//    $vars['title_attributes_array']['class'][] = 'element-invisible';
//  }
//}

function incubator_blogline_alpha_process_region(&$vars) {
...
function incubator_blogline_alpha_process_zone(&$vars) {
...
function incubator_blogline_alpha_process_html(&$vars) {
  if (module_exists('color')) {
    _color_html_alter($vars);
  }
}

function incubator_blogline_alpha_process_page(&$vars) {
  if (module_exists('color')) {
...
function incubator_blogline_alpha_preprocess_node(&$vars) {
...
function incubator_blogline_form_system_theme_settings_alter(&$form, &$form_state) {
  if ($form['var']['#value'] == 'theme_incubator_blogline_settings') {
    ...
    $form['incubator_blogline_alpha_settings'] = array(
      '#type' => 'container',
      '#weight' => 50,
      '#states' => array(
        'invisible' => array(
    ...
    $form['incubator_blogline_alpha_settings']['alpha_settings'] = $form['alpha_settings'];
